...
Created: Sun Aug 27 2023 07:20:38 GMT-0400 (Eastern Daylight Time)
...
export const ServerChannel = ({
  ...
  return (
    ...
    >
      ...
      {/* if the channel is not general and the user is not a member, show the edit and delete icons */}
      ...
      {/* if the channel is general, show the lock icon */}
