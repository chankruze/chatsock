...
Created: Mon Aug 28 2023 13:45:35 GMT-0400 (Eastern Daylight Time)
...
type MessageWithSenderWithProfile = Message & {
  sender: Member & {
    profile: Profile;
  };
};
...
export const ChatMessages = ({
  ...
  return (
    <div
      ref={chatRef}
      className="scrollbar-thin flex flex-1 flex-col overflow-y-auto py-4"
    >
